...
export const clientLoader = async() => {
  const [user, dashboardStats, trips, userGrowth, tripsByStyle, allUsers] = await Promise.all([
    await getUser(),
...
const dashboard = ({ loaderData }: Route.ComponentProps ) => {
  ...
  const { dashboardStats, allTrips, userGrowth, tripsByStyle, allUsers } = loaderData;
